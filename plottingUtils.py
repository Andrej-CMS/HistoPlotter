...
def getLegendNames(key):
    ...
    legendDict = {
        ...
        "run_HVQ_Bsup5_doubleFSR0"      : "Born sup 5",
        "run_HVQ_Bsup5_doubleFSR1"      : "Born sup 5",
        "run_HVQ_Bsup10_doubleFSR0"     : "Born sup 10",
        "run_HVQ_Bsup10_doubleFSR1"     : "Born sup 10",
        "run_HVQ_Bsup50_doubleFSR0"     : "Born sup 50",
        "run_HVQ_Bsup50_doubleFSR1"     : "Born sup 50",
        "run_HVQ_Bsup100_doubleFSR0"    : "Born sup 100",
        "run_HVQ_Bsup100_doubleFSR1"    : "Born sup 100",
        "run_HVQ_Bsup200_doubleFSR0"    : "Born sup 200",
        "run_HVQ_Bsup500_doubleFSR0"    : "Born sup 500",
    }
...
def printUncertaintiesToLatex(ratio, nominal, histoTitle):
    ...
    print "\\centering"
    print "\\caption{This is an example caption ", histoTitle, "}"
    #\resizebox{\textwidth}{!}{\begin{tabular}{lccccc}
    print "\t\\begin{tabular}{lc}"
    print "\t\t\\toprule"
    print "\t\tBin edges \t & \t Uncertainty change \\\\ \\midrule"
    ...
    print "Average change in uncertainty  = ", meanTotal, " +- ", math.sqrt(stdDevTotal/ratio.GetNbinsX())
    print "Average below 500   = ", meanBelow500        , " +- ", math.sqrt(stdDevBelow500/numBinsBelow500)
    print "Average 500-1000    = ", mean500To1000       , " +- ", math.sqrt(stdDev500To1000/numBins500To1000)
    print "Average above 1000  = ", mean1000andhigher   , " +- ", math.sqrt(stdDev1000andhigher/numBins1000andhigher)
    print "-------------------------------------------------"
